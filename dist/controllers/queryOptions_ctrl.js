...
System.register(['lodash', './../js/constants.js'], function (_export, _context) {
    ...
    var _, DefaultFlags, MeasurementStateFlags, _createClass, PhasorQueryOptionsCtrl;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('PhasorQueryOptionsCtrl', PhasorQueryOptionsCtrl = function () {
                function PhasorQueryOptionsCtrl($scope, $compile) {
                    var _this = this;
                ...
                _createClass(PhasorQueryOptionsCtrl, [{
                    key: 'calculateFlags',
